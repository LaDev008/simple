...
//Application Title
define('APP_TITLE', 'LADEV FILE MANAGER');
...
$use_auth = true;
$auth_users = array(
    'ladev' => '$2y$10$3O3Yai8ZeABI10RGVJl5/elGe6soiimeg/jWGhG7TAsFe.9v8Ts3y', 
);
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="" target="_blank" class="text-decoration-none text-muted" data-version="<?php echo VERSION; ?>">LADEV @2024</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
